...
class User {
	constructor(
		...
		this.profileImage = profileImage ?? "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Gull_ca_usa.jpg/1200px-Gull_ca_usa.jpg",
		this.bio =
			bio ??
		...
		this.hashedPassword =
			hashedPassword ?? String(bcript.hashSync("Password"));
