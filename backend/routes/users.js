...
router.get('/current/:id', asyncHandler(async (req, res) => {
...
router.patch("/:id", asyncHandler(async (req, res) => {
    ...
    if (updateUser) {
        ...
        throw new Error(`Could not update user because incorrect value was retrieved in the request body: ${updateUser}`)
    }
}))

router.post('/', validateSignup, asyncHandler(async (req, res) => {
    const {username, email, firstName, lastName, profileImage, bio, hashedPassword} = req.body
